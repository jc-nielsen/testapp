# `testapp` — AngularJS 1.5 skeleton app for chart development
...
Clone the `testapp` repository using git:

```
git clone https://github.com/jc-nielsen/testapp.git
cd testapp
```

If you just want to start a new project without the `testapp` commit history then you can do:

```
git clone --depth=1 https://github.com/jc-nielsen/testapp.git <your-project-name>
```
